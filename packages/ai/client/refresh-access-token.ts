...
/** Same-origin refresh endpoint that forwards the refresh grant server-side. */
const WORKOS_TOKEN_ENDPOINT = "/api/auth/refresh";
...
class MissingInput extends Data.TaggedError("MissingInput")<{
...
export function refreshAccessToken(
	...
	MissingInput | NetworkError | RequestError | ResponseError
> {
	return Effect.gen(function* () {
		...
		yield* requireTrimmed(options.clientId, "clientId");
		yield* requireTrimmed(options.clientSecret, "clientSecret");
